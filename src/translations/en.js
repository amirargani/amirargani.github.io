...
var en = {
  ...
  cv_exp_2_p1: "Conception and implementation of scalable backend architectures",
  cv_exp_2_p2: "Development and orchestration of ML workflows for analysis in production systems",
  ...
  chatbot_greeting: "Hello! I am OrbiAI, Amir's AI Assistant. Feel free to ask me anything about his resume, projects, or technical skills.",
  chatbot_error: "Sorry, there was a problem connecting. Please try again later.",
  chatbot_limitReached: "You have reached your daily limit of 20 questions. Please try again tomorrow!",
  chatbot_suggestion1: "Summarize Amir Argani's resume.",
  chatbot_suggestion2: "What technical skills does Amir Argani have?",
  chatbot_suggestion3: "Tell me more about CRObuzzer.",
  chatbot_suggestion4: "How can I contact Amir Argani?",
  chatbot_suggestion5: "What projects has Amir Argani worked on?",
  chatbot_suggestion6: "Tell me more about his training at DSI Berlin.",
  chatbot_historyTitle: "History",
  chatbot_fullscreenTitle: "Fullscreen",
  chatbot_settingsTitle: "Settings",
  chatbot_newChatTooltip: "Create new chat",
  chatbot_historyTooltip: "Show history",
  chatbot_settingsTooltip: "Show settings",
  chatbot_optionsTooltip: "Options",
  chatbot_deleteAllBtn: "Delete All",
  chatbot_deleteAllConfirmTitle: "Delete All Chats",
  chatbot_deleteAllConfirmDesc: "Are you sure you want to delete all chat histories? This action cannot be undone.",
  chatbot_emptyHistory: "No saved chats available.",
  chatbot_settingsAutoDelete: "Auto-Delete Chats",
  chatbot_settingsAutoDeleteDesc: "Automatically purges saved chats from local storage after a set period.",
  chatbot_settingsDeactivate: "Deactivate Chatbot",
  chatbot_settingsDeactivateDesc: "Completely hides the chatbot icon. Can be re-enabled via the Cookie Settings in the footer.",
  chatbot_settingsDeactivateConfirm: "Are you sure you want to deactivate the chatbot? The icon will be hidden, saves no data and deletes all history.",
  chatbot_deactivateTitle: "Deactivate Chatbot",
  chatbot_deactivateDecline: "Decline",
  chatbot_deactivateConfirm: "Confirm",
  chatbot_limitTitle: "Storage Limit Reached",
  chatbot_limitMessage: "Limit of 30 saved chats reached! Please delete old chats to make room.",
  chatbot_limitActionDelete3: "Delete 3 oldest",
  chatbot_limitActionDelete5: "Delete 5 oldest",
  chatbot_limitActionDelete7: "Delete 7 oldest",
  chatbot_limitActionDeleteAll: "Delete all",
  chatbot_limitActionCancel: "Cancel",
  chatbot_autoDeleteDays: "Days",
  chatbot_deactivateBtn: "Deactivate"
};
